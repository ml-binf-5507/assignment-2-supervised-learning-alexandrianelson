...
2. **What specific things did you ask them to do?** (Be specific)
   ...
   I used it to help me with debugging and to ask about function syntax, which was helpful because I was getting a lot of errors during the testing phase. I also asked it for help with explanations of certain terminology like ElasticNet and gridsearch just so I can understand it better. I also struggled with graphing for a while, and I didn't understand why matplotlib needed both a figure and ax object to create the figure. So, I asked chatgpt for explanations on that syntax. Any time I asked for help, I asked that it didn't rewrite code for me, just review it and give suggestions for improvement.
...
Honestly, I'm still getting accquainted with the theory that goes into machine learning. I understand the basics about supervised learning but translating that into code has been harder for me. I understand the purpose of data cleaning and splitting but passed that, it gets a little confusing. 
